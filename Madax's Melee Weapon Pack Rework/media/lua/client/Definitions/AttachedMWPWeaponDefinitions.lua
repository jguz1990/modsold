...
local wTable = AttachedWeaponDefinitions.attachedWeaponCustomOutfit.PrivateMilitia.weapons
table.insert(wTable, AttachedWeaponDefinitions.MWPknivesBelt)
-- table.insert(wTable, AttachedWeaponDefinitions.MWPnightstick)

local wTable = AttachedWeaponDefinitions.attachedWeaponCustomOutfit.Bandit.weapons
table.insert(wTable, AttachedWeaponDefinitions.MWPmeleeInBack)
table.insert(wTable, AttachedWeaponDefinitions.MWPmeleeInBack)
table.insert(wTable, AttachedWeaponDefinitions.MWPhammerBelt)
table.insert(wTable, AttachedWeaponDefinitions.MWPknivesBelt)
table.insert(wTable, AttachedWeaponDefinitions.MWPbladeInBack)

-- local wTable = AttachedWeaponDefinitions.attachedWeaponCustomOutfit.Police.weapons
-- table.insert(wTable, AttachedWeaponDefinitions.MWPnightstick)

-- local wTable = AttachedWeaponDefinitions.attachedWeaponCustomOutfit.PoliceState.weapons
-- table.insert(wTable, AttachedWeaponDefinitions.MWPnightstick)

-- local wTable = AttachedWeaponDefinitions.attachedWeaponCustomOutfit.PoliceRiot.weapons
-- table.insert(wTable, AttachedWeaponDefinitions.MWPnightstick)