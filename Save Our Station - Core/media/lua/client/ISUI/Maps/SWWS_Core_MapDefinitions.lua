...
function SWWS_Core_MapUtils.initDirectoryMapData(mapUI, directory)
...
LootMaps.Init.SWWS_Core_DiagnosticManual = function(mapUI)
	local mapAPI = mapUI.javaObject:getAPIv1()
	SWWS_Core_MapUtils.initDirectoryMapData(mapUI, 'media/maps/Muldraugh, KY')
	mapAPI:setBoundsInSquares(0, 0, 1396, 1735)
	overlayPNG(mapUI, 0, 0, 1, "lootMapPNG", "media/ui/content/swws_error_codes.png", 1.0)
end
