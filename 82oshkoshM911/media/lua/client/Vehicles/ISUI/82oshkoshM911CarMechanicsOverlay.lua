...
ISCarMechanicsOverlay.CarList["Base.82oshkoshM911"] = {imgPrefix = "82oshkoshM911_", x=10,y=0};
--
ISCarMechanicsOverlay.PartList["Battery"].vehicles = ISCarMechanicsOverlay.PartList["Battery"].vehicles or {};
ISCarMechanicsOverlay.PartList["Battery"].vehicles["82oshkoshM911_"] = {img="battery", x=14,y=298,x2=58,y2=331};
--
...
ISCarMechanicsOverlay.PartList["SuspensionFrontLeft"].vehicles["82oshkoshM911_"] = {img="suspension_front_left", x=14,y=132,x2=55,y2=170};
...
ISCarMechanicsOverlay.PartList["SuspensionFrontRight"].vehicles["82oshkoshM911_"] = {img="suspension_front_right", x=228,y=132,x2=268,y2=170};
--
ISCarMechanicsOverlay.PartList["SuspensionRearLeft"].vehicles = ISCarMechanicsOverlay.PartList["SuspensionRearLeft"].vehicles or {};
ISCarMechanicsOverlay.PartList["SuspensionRearLeft"].vehicles["82oshkoshM911_"] = {x=14,y=412,x2=55,y2=450};
