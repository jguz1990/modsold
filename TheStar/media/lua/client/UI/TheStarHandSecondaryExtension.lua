...
local function initUI()
    if ISEquippedItem.instance and not ISEquippedItem.instance.handSecondaryExtensionUI then
        handSecondaryExtensionUI = UIHandSecondaryExtension:new(39, 58)
        handSecondaryExtensionUI:initialise()
        handSecondaryExtensionUI:setVisible(false)
        handSecondaryExtensionUI.parent = ISEquippedItem.instance
        ISEquippedItem.instance:addChild(handSecondaryExtensionUI)
        ISEquippedItem.instance.handSecondaryExtensionUI = handSecondaryExtensionUI
    end
end
