...
LootMaps.Init.STBernardHillMap = function(mapUI)
	local mapAPI = mapUI.javaObject:getAPIv1()
	MapUtils.initDirectoryMapData(mapUI, 'media/maps/StBernardshill')
	MapUtils.initDefaultStyleV1(mapUI)
	replaceWaterStyle(mapUI)
	mapAPI:setBoundsInSquares(11487, 11486, 12985, 12395)
	overlayPNG(mapUI, 11487, 11486, 0.666, "badge", "media/textures/worldMap/StBernardshillBadge.png")
	overlayPNG(mapUI, 11487, 12000, 0.666, "legend", "media/textures/worldMap/Legend.png")
