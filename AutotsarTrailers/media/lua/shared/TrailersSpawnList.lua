...
VehicleZoneDistribution.medium.vehicles["Base.TrailerHomeExplorer"] = {index = -1, spawnChance = 2};
VehicleZoneDistribution.parkingstall.vehicles["Base.TrailerGenerator"] = {index = -1, spawnChance = 2};
...
VehicleZoneDistribution.junkyard.vehicles["Base.TrailerSecond"] = {index = -1, spawnChance = 2};
...
VehicleZoneDistribution.trafficjamw.vehicles["Base.TrailerKbac"] = {index = -1, spawnChance = 2};
