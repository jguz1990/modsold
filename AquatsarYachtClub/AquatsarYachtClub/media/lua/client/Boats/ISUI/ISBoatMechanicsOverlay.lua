...
ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYacht_Ground"] = {imgPrefix = "salingboatWS_", x=10,y=-30};
-- ISBoatMechanicsOverlay.BoatList["Base.BoatSailingYacht"] = {imgPrefix = "salingboatWS_", x=10,y=-30};
...
ISBoatMechanicsOverlay.BoatList["Base.BoatMotor_Ground"] = {imgPrefix = "motorboat_", x=10,y=-30};
